...
class ActorsIndividualPage extends StatelessWidget {
  const ActorsIndividualPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Actor Statistics'),
      ),
      body: Table(
          ...
          TableRow(
            children: [
              GestureDetector(
                ...
                child: const Text('Actor Name', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
              ),
