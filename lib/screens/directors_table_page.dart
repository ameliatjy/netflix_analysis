...
class DirectorsTablePage extends ConsumerWidget {
  const DirectorsTablePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, ref) {
    final data = ref.watch(directorsProvider);
    return Scaffold(
      appBar: AppBar(
        ...
        data: (data) {
          return Column(
            children: [
              ...
              const Text('Click on any director name to view more details.', style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              Table(
